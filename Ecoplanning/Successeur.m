...
{
    successeur = [NSMutableDictionary dictionaryWithObjectsAndKeys:snumero_,@"snumero",sdesignation_, @"sdesignation", sduree_, @"sduree",psDebTot_,@"sDebTot",sLien_, @"sLien",sDecal_, @"sDecal",DebavTache_, @"DebavTache", nil];
    nombreSuccesseur++;
}
